    ...
    <div style={{ background: "var(--background)", minHeight: "100vh" }}>
      ...
      <div style={{ background: "var(--primary)", color: "white", padding: "5rem 1.25rem 6rem" }}>
        <div style={{ maxWidth: "860px", margin: "0 auto" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "1.05rem", lineHeight: 1.8, maxWidth: "620px" }}>
      ...
      <div style={{ maxWidth: "860px", margin: "0 auto", padding: "4rem 1.25rem 5rem" }}>
        ...
        {/* Values grid — auto-fill handles mobile naturally */}
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: "1.25rem", marginBottom: "5rem" }}>
          {[
            { icon: <Shield size={26} />, title: "Conservation First", body: "Every decision we make is measured against one question: does this protect and sustain wildlife? Our fieldwork, partnerships, and funding all serve this singular purpose." },
        ...
        <div className="about-story-grid">
          ...
          <div className="about-photo-placeholder" style={{ background: "var(--primary)", borderRadius: "var(--radius-md)", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: "0.5rem", color: "rgba(255,255,255,0.4)", fontSize: "0.85rem" }}>
        ...
        <div className="glass-card" style={{ padding: "2.5rem 2rem" }}>
          <h2 style={{ fontSize: "clamp(1.4rem,3vw,2rem)", marginBottom: "2rem" }}>Where Your Pledge Goes</h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: "1rem" }}>
            {[
              ...
              <div key={item.label} style={{ textAlign: "center", padding: "1.25rem 0.75rem" }}>
                <div style={{ fontSize: "2.2rem", fontWeight: 800, fontFamily: "var(--font-heading)", color: "var(--accent)", marginBottom: "0.5rem" }}>{item.pct}</div>
                <div style={{ opacity: 0.65, fontSize: "0.875rem", lineHeight: 1.5 }}>{item.label}</div>
              </div>
            ))}
          </div>
        </div>
